...
write_csv(all_fishing_positions_in_eez, "all_fishing_positions_in_eez.csv")

write_csv(summary_all_effort_by_ARG_vessel, "summary_all_effort_by_ARG_vessel.csv")
```
...
```{r}
all_fishing_positions_in_eez <- read_csv("all_fishing_positions_in_eez.csv")
...
colnames(summary_of_effort_within_MPAs) <- c("year", "mmsi", "fishing_hours_mpa_1", "fishing_hours_mpa_2", "fishing_hours_mpa_3", "fishing_hours_mpa_4", "fishing_hours_mpa_5", "fishing_hours_mpa_6", "fishing_hours_mpa_8",  "fishing_hours_mpa_10", "fishing_hours_mpa_11", "fishing_hours_mpa_12", "fishing_hours_mpa_13", "fishing_hours_mpa_14")
```

```{r}
summary_all_effort_by_ARG_vessel <- read_csv("summary_all_effort_by_ARG_vessel.csv")
